...
public class Lekerdezes4 implements Initializable {
    ...
    private void SQL() {
        try {
            ...
            String SQL = "SELECT `Megálló_Név` FROM `megallo_azonosito` WHERE `Megálló_Azonosító`IN(SELECT Megálló_Azonosító FROM menetrend WHERE " +
                    "Jármű_Azonosító=(SELECT Jármű_Azonosító FROM jarmu_azonosito WHERE Járatszám='90F'))";
            ...
            Logger.getLogger(Lekerdezes4.class.getName()).log(Level.SEVERE,null,ex);
        }
    }
